...
![新建 Prompt / Snippet](assets/prompt-factory-05-create-prompt-snippet.png)
...
![新建 Tool / Label](assets/prompt-factory-06-create-tool-label.png)
...
![新建 API Token](assets/prompt-factory-07-create-api-token.png)
