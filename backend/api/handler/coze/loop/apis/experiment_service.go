...
// ListPromptOptimizeTasks .
// @router /api/prompt/v1/prompts/:prompt_id/optimize_tasks/list [POST]
func ListPromptOptimizeTasks(ctx context.Context, c *app.RequestContext) {
	invokeAndRender(ctx, c, localExptSvc.ListPromptOptimizeTasks)
}

// EstimatePromptOptimizeTaskResourceUsage .
// @router /api/prompt/v1/prompts/:prompt_id/optimize_tasks/evaluate [POST]
func EstimatePromptOptimizeTaskResourceUsage(ctx context.Context, c *app.RequestContext) {
	invokeAndRender(ctx, c, localExptSvc.EstimatePromptOptimizeTaskResourceUsage)
}

// CreatePromptOptimizeTask .
// @router /api/prompt/v1/prompts/:prompt_id/optimize_tasks [POST]
func CreatePromptOptimizeTask(ctx context.Context, c *app.RequestContext) {
	invokeAndRender(ctx, c, localExptSvc.CreatePromptOptimizeTask)
}

// GetPromptOptimizeTask .
// @router /api/prompt/v1/prompts/:prompt_id/optimize_tasks/:task_id [POST]
