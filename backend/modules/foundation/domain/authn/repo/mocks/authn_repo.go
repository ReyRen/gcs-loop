...
// Source: modules\foundation\domain\authn\repo\authn_repo.go
//
// Generated by this command:
//
//	gcs-loop-mockgen -source=modules\foundation\domain\authn\repo\authn_repo.go -destination=modules\foundation\domain\authn\repo\mocks\authn_repo.go -package=mocks
//
...
func (m *MockIAuthNRepo) GetAPIKeyByUser(ctx context.Context, userID int64, pageNumber, pageSize int) ([]*entity.APIKey, int64, error) {
	m.ctrl.T.Helper()
