...
func InitExperimentApplication(ctx context.Context, idgen2 idgen.IIDGenerator, db2 db.Provider, configFactory conf.IConfigLoaderFactory, rmqFactory mq.IFactory, cmdable redis.Cmdable, auditClient audit.IAuditService, meter metrics.Meter, authClient authservice.Client, evalSetService evaluation.EvaluationSetService, evaluatorService evaluation.EvaluatorService, targetService evaluation.EvalTargetService, uc userservice.Client, pms promptmanageservice.Client, pes promptexecuteservice.Client, sds datasetservice.Client, limiterFactory limiter.IRateLimiterFactory, llmcli llmruntimeservice.Client, benefitSvc benefit.IBenefitService, ckDb ck.Provider, tagClient tagservice.Client, taskClientFactory func() taskservice.Client, objectStorage fileserver.ObjectStorage, batchObjectStorage fileserver.BatchObjectStorage, plainLimiterFactory limiter.IPlainRateLimiterFactory, trajectoryAdapter rpc.ITrajectoryAdapter, fileClient fileservice.Client, scheduleAdapter rpc.IExptScheduleAdapter) (IExperimentApplication, error) {
	...
	iEvaluatorScoreCalculator := service.NewEvaluatorScoreCalculator(componentIConfiger, iClient)
	evaluatorRecordService := service.NewEvaluatorRecordServiceImpl(idgen2, iEvaluatorRecordRepo, exptEventPublisher, evaluatorEventPublisher, userInfoService, iExperimentRepo, iExptTurnResultRepo, iEvaluatorScoreCalculator)
	...
	sandboxSchedulerAdapter := agent_studio.NewSandboxSchedulerAdapter()
	sandboxAgentMetrics := sandbox_agent.NewSandboxAgentMetrics(meter)
	v2 := service.NewSourceTargetOperators(iPromptRPCAdapter, idgen2, sandboxSchedulerAdapter, sandboxAgentMetrics)
	iExptRunLogDAO := mysql.NewExptRunLogDAO(db2)
	iExptRunLogRepo := experiment.NewExptRunLogRepo(iExptRunLogDAO)
	iEvalTargetService := service.NewEvalTargetServiceImpl(iEvalTargetRepo, idgen2, evalTargetMetrics, v2, trajectoryAdapter, componentIConfiger, sandboxSchedulerAdapter, iExptRunLogRepo)
	...
	iDatasetRPCAdapter := data.NewDatasetRPCAdapter(sds, iFileProvider)
	...
	applicationExperimentApplication := NewExperimentApplication(exptAggrResultService, exptResultService, iExptManager, exptSchedulerEvent, exptItemEvalEvent, idgen2, componentIConfiger, iAuthProvider, userInfoService, iEvalTargetService, evaluationSetItemService, iExptAnnotateService, iTagRPCAdapter, iExptResultExportService, iExptInsightAnalysisService, serviceEvaluatorService, iExptTemplateManager, iFileProvider, exptLifecycleEventHandler, sandboxSchedulerAdapter, sandboxAgentMetrics)
	iExperimentApplication := NewExperimentApplicationWithPromptOptimization(ctx, applicationExperimentApplication, db2, illmProvider, iPromptRPCAdapter)
...
func InitEvaluatorApplication(ctx context.Context, idgen2 idgen.IIDGenerator, authClient authservice.Client, db2 db.Provider, configFactory conf.IConfigLoaderFactory, rmqFactory mq.IFactory, llmClient llmruntimeservice.Client, meter metrics.Meter, userClient userservice.Client, auditClient audit.IAuditService, cmdable redis.Cmdable, benefitSvc benefit.IBenefitService, limiterFactory limiter.IRateLimiterFactory, fileClient fileservice.Client, plainLimiterFactory limiter.IPlainRateLimiterFactory, ckDb ck.Provider, tagClient tagservice.Client, promptClient promptmanageservice.Client, pec promptexecuteservice.Client, dataClient datasetservice.Client, tracerFactory func() observabilitytraceservice.Client, batchObjectStorage fileserver.BatchObjectStorage) (evaluation.EvaluatorService, error) {
	...
	iExptRunLogDAO := mysql.NewExptRunLogDAO(db2)
	iExptRunLogRepo := experiment.NewExptRunLogRepo(iExptRunLogDAO)
	iEvalTargetService := service.NewEvalTargetServiceImpl(iEvalTargetRepo, idgen2, evalTargetMetrics, v2, iTrajectoryAdapter, componentIConfiger, sandboxSchedulerAdapter, iExptRunLogRepo)
	iDatasetRPCAdapter := data.NewDatasetRPCAdapter(dataClient, iFileProvider)
	evaluationSetVersionService := service.NewEvaluationSetVersionServiceImpl(iDatasetRPCAdapter)
	iEvaluationSetService := service.NewEvaluationSetServiceImpl(iDatasetRPCAdapter)
	evaluationSetItemService := service.NewEvaluationSetItemServiceImpl(iDatasetRPCAdapter)
	iTagRPCAdapter := tag.NewTagRPCProvider(tagClient)
...
func InitEvaluationSetApplication(client datasetservice.Client, authClient authservice.Client, meter metrics.Meter, userClient userservice.Client, configFactory conf.IConfigLoaderFactory, fileClient fileservice.Client) (evaluation.EvaluationSetService, error) {
	iAuthProvider := foundation.NewAuthRPCProvider(authClient)
	iFileProvider := foundation.NewFileRPCProvider(fileClient)
	iDatasetRPCAdapter := data.NewDatasetRPCAdapter(client, iFileProvider)
	iEvaluationSetService := service.NewEvaluationSetServiceImpl(iDatasetRPCAdapter)
...
func InitEvalTargetApplication(ctx context.Context, idgen2 idgen.IIDGenerator, db2 db.Provider, client promptmanageservice.Client, executeClient promptexecuteservice.Client, authClient authservice.Client, cmdable redis.Cmdable, meter metrics.Meter, trajectoryAdapter rpc.ITrajectoryAdapter, configFactory conf.IConfigLoaderFactory, batchObjectStorage fileserver.BatchObjectStorage) (evaluation.EvalTargetService, error) {
	...
	sandboxSchedulerAdapter := agent_studio.NewSandboxSchedulerAdapter()
	sandboxAgentMetrics := sandbox_agent.NewSandboxAgentMetrics(meter)
	v := service.NewSourceTargetOperators(iPromptRPCAdapter, idgen2, sandboxSchedulerAdapter, sandboxAgentMetrics)
	iExptRunLogDAO := mysql.NewExptRunLogDAO(db2)
	iExptRunLogRepo := experiment.NewExptRunLogRepo(iExptRunLogDAO)
...
func InitEvalOpenAPIApplication(ctx context.Context, configFactory conf.IConfigLoaderFactory, rmqFactory mq.IFactory, cmdable redis.Cmdable, idgen2 idgen.IIDGenerator, db2 db.Provider, client promptmanageservice.Client, executeClient promptexecuteservice.Client, authClient authservice.Client, meter metrics.Meter, dataClient datasetservice.Client, userClient userservice.Client, llmClient llmruntimeservice.Client, tagClient tagservice.Client, limiterFactory limiter.IRateLimiterFactory, objectStorage fileserver.ObjectStorage, batchObjectStorage fileserver.BatchObjectStorage, auditClient audit.IAuditService, benefitService benefit.IBenefitService, ckProvider ck.Provider, plainLimiterFactory limiter.IPlainRateLimiterFactory, trajectoryAdapter rpc.ITrajectoryAdapter, fileClient fileservice.Client, taskClientFactory func() taskservice.Client, scheduleAdapter rpc.IExptScheduleAdapter) (IEvalOpenAPIApplication, error) {
	...
	iClient := http.NewHTTPClient()
	iEvaluatorScoreCalculator := service.NewEvaluatorScoreCalculator(iConfiger, iClient)
	evaluatorRecordService := service.NewEvaluatorRecordServiceImpl(idgen2, iEvaluatorRecordRepo, exptEventPublisher, evaluatorEventPublisher, userInfoService, iExperimentRepo, iExptTurnResultRepo, iEvaluatorScoreCalculator)
	iTagRPCAdapter := tag.NewTagRPCProvider(tagClient)
	iExptTurnAnnotateRecordRefDAO := mysql.NewExptTurnAnnotateRecordRefDAO(db2)
	iExptTurnResultTagRefDAO := mysql.NewExptTurnResultTagRefDAO(db2)
	...
	webhookDispatcher := service.NewWebhookDispatcher(exptEventPublisher, noopWebhookSecretProvider, iExptStatsRepo)
	exptLifecycleEventHandler := service.NewExptLifecycleEventHandler(iExperimentRepo, iNotifyRPCAdapter, iUserProvider, webhookDispatcher)
	applicationExperimentApplication := NewExperimentApplication(exptAggrResultService, exptResultService, iExptManager, exptSchedulerEvent, exptItemEvalEvent, idgen2, iConfiger, iAuthProvider, userInfoService, iEvalTargetService, evaluationSetItemService, iExptAnnotateService, iTagRPCAdapter, iExptResultExportService, iExptInsightAnalysisService, evaluatorService, iExptTemplateManager, iFileProvider, exptLifecycleEventHandler, sandboxSchedulerAdapter, sandboxAgentMetrics)
	iExperimentApplication := NewExperimentApplicationWithPromptOptimization(ctx, applicationExperimentApplication, db2, illmProvider, iPromptRPCAdapter)
...
var (
	...
	evaluationSetSet = wire.NewSet(
		NewEvaluationSetApplicationImpl, conf2.NewSharedResourceConfigProvider, service.NewResourceAccessAuthorizer, service.EvaluationSetDomainServiceSet, metrics4.EvaluationSetMetricsSet, foundation.FoundationRPCSet, userinfo.NewUserInfoServiceImpl,
	)

	evalTargetSet = wire.NewSet(
		NewEvalTargetHandlerImpl, conf2.NewSharedResourceConfigProvider, service.NewResourceAccessAuthorizer, service.TargetDomainServiceSet, metrics3.EvalTargetMetricsSet, sandbox_agent.SandboxAgentMetricsSet, foundation.FoundationRPCSet, experiment.ExperimentRepoSet, flagSet, storage.StorageSet,
	)
