...
func (p *ListTrajectoryOApiRequest) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ListTrajectoryOApiRequest[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_ListTrajectoryOApiRequest[fieldId]))
}

func (p *ListTrajectoryOApiRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *ListTrajectoryOApiRequest) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *ListTrajectoryOApiRequest) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
func (p *ListTrajectoryOApiRequest) FastReadField255(buf []byte) (int, error) {
	offset := 0
	_field := base.NewBase()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
func (p *ListTrajectoryOApiRequest) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *ListTrajectoryOApiRequest) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
		offset += p.fastWriteField3(buf[offset:], w)
...
func (p *ListTrajectoryOApiRequest) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
...
func (p *ListTrajectoryOApiRequest) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 1)
	offset += thrift.Binary.WriteI64(buf[offset:], p.WorkspaceID)
	return offset
...
func (p *ListTrajectoryOApiRequest) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *ListTrajectoryOApiRequest) fastWriteField3(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetStartTime() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 3)
		offset += thrift.Binary.WriteI64(buf[offset:], *p.StartTime)
...
func (p *ListTrajectoryOApiRequest) fastWriteField254(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetExtra() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 254)
		offset += p.Extra.FastWriteNocopy(buf[offset:], w)
...
func (p *ListTrajectoryOApiRequest) fastWriteField255(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetBase() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 255)
		offset += p.Base.FastWriteNocopy(buf[offset:], w)
...
func (p *ListTrajectoryOApiRequest) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += thrift.Binary.I64Length()
	return l
...
func (p *ListTrajectoryOApiRequest) field2Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += thrift.Binary.ListBeginLength()
	for _, v := range p.TraceIds {
...
func (p *ListTrajectoryOApiRequest) field3Length() int {
	l := 0
	if p.IsSetStartTime() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.I64Length()
...
func (p *ListTrajectoryOApiRequest) field255Length() int {
	l := 0
	if p.IsSetBase() {
		l += thrift.Binary.FieldBeginLength()
		l += p.Base.BLength()
...
func (p *ListTrajectoryOApiRequest) DeepCopy(s interface{}) error {
	src, ok := s.(*ListTrajectoryOApiRequest)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *ListTrajectoryOApiResponse) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ListTrajectoryOApiResponse[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *ListTrajectoryOApiResponse) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *ListTrajectoryOApiResponse) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *ListTrajectoryOApiResponse) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
func (p *ListTrajectoryOApiResponse) FastReadField255(buf []byte) (int, error) {
	offset := 0
	_field := base.NewBaseResp()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
func (p *ListTrajectoryOApiResponse) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *ListTrajectoryOApiResponse) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
		offset += p.fastWriteField2(buf[offset:], w)
...
func (p *ListTrajectoryOApiResponse) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
...
func (p *ListTrajectoryOApiResponse) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetCode() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I32, 1)
		offset += thrift.Binary.WriteI32(buf[offset:], *p.Code)
...
func (p *ListTrajectoryOApiResponse) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetMsg() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRING, 2)
		offset += thrift.Binary.WriteStringNocopy(buf[offset:], w, *p.Msg)
...
func (p *ListTrajectoryOApiResponse) fastWriteField3(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetData() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 3)
		offset += p.Data.FastWriteNocopy(buf[offset:], w)
...
func (p *ListTrajectoryOApiResponse) fastWriteField255(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetBaseResp() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 255)
		offset += p.BaseResp.FastWriteNocopy(buf[offset:], w)
...
func (p *ListTrajectoryOApiResponse) field1Length() int {
	l := 0
	if p.IsSetCode() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.I32Length()
...
func (p *ListTrajectoryOApiResponse) field2Length() int {
	l := 0
	if p.IsSetMsg() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.StringLengthNocopy(*p.Msg)
...
func (p *ListTrajectoryOApiResponse) field3Length() int {
	l := 0
	if p.IsSetData() {
		l += thrift.Binary.FieldBeginLength()
		l += p.Data.BLength()
...
func (p *ListTrajectoryOApiResponse) field255Length() int {
	l := 0
	if p.IsSetBaseResp() {
		l += thrift.Binary.FieldBeginLength()
		l += p.BaseResp.BLength()
...
func (p *ListTrajectoryOApiResponse) DeepCopy(s interface{}) error {
	src, ok := s.(*ListTrajectoryOApiResponse)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
	...
	var _data *ListTrajectoryOApiData
	if src.Data != nil {
		_data = &ListTrajectoryOApiData{}
		if err := _data.DeepCopy(src.Data); err != nil {
			return err
		}
	}
...
func (p *ListTrajectoryOApiData) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ListTrajectoryOApiData[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_ListTrajectoryOApiData[fieldId]))
}

func (p *ListTrajectoryOApiData) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *ListTrajectoryOApiData) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *ListTrajectoryOApiData) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
	}
...
func (p *ListTrajectoryOApiData) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
	}
...
func (p *ListTrajectoryOApiData) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.LIST, 1)
	listBeginOffset := offset
	offset += thrift.Binary.ListBeginLength()
...
func (p *ListTrajectoryOApiData) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += thrift.Binary.ListBeginLength()
	for _, v := range p.Trajectories {
...
func (p *ListTrajectoryOApiData) DeepCopy(s interface{}) error {
	src, ok := s.(*ListTrajectoryOApiData)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *OpenAPIServiceListTrajectoryOApiArgs) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_OpenAPIServiceListTrajectoryOApiArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *OpenAPIServiceListTrajectoryOApiArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *OpenAPIServiceListTrajectoryOApiArgs) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *OpenAPIServiceListTrajectoryOApiArgs) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
	}
...
func (p *OpenAPIServiceListTrajectoryOApiArgs) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
	}
...
func (p *OpenAPIServiceListTrajectoryOApiArgs) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 1)
	offset += p.Req.FastWriteNocopy(buf[offset:], w)
	return offset
...
func (p *OpenAPIServiceListTrajectoryOApiArgs) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Req.BLength()
	return l
...
func (p *OpenAPIServiceListTrajectoryOApiArgs) DeepCopy(s interface{}) error {
	src, ok := s.(*OpenAPIServiceListTrajectoryOApiArgs)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	var _req *ListTrajectoryOApiRequest
	if src.Req != nil {
		_req = &ListTrajectoryOApiRequest{}
		if err := _req.DeepCopy(src.Req); err != nil {
			return err
		}
	}
...
func (p *OpenAPIServiceListTrajectoryOApiResult) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_OpenAPIServiceListTrajectoryOApiResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *OpenAPIServiceListTrajectoryOApiResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
func (p *OpenAPIServiceListTrajectoryOApiResult) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *OpenAPIServiceListTrajectoryOApiResult) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField0(buf[offset:], w)
	}
...
func (p *OpenAPIServiceListTrajectoryOApiResult) BLength() int {
	l := 0
	if p != nil {
		l += p.field0Length()
	}
...
func (p *OpenAPIServiceListTrajectoryOApiResult) fastWriteField0(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetSuccess() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 0)
		offset += p.Success.FastWriteNocopy(buf[offset:], w)
...
func (p *OpenAPIServiceListTrajectoryOApiResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += thrift.Binary.FieldBeginLength()
		l += p.Success.BLength()
...
func (p *OpenAPIServiceListTrajectoryOApiResult) DeepCopy(s interface{}) error {
	src, ok := s.(*OpenAPIServiceListTrajectoryOApiResult)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	var _success *ListTrajectoryOApiResponse
	if src.Success != nil {
		_success = &ListTrajectoryOApiResponse{}
		if err := _success.DeepCopy(src.Success); err != nil {
			return err
		}
	}
...
func (p *OpenAPIServiceListTrajectoryOApiArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *OpenAPIServiceListTrajectoryOApiResult) GetResult() interface{} {
	return p.Success
}
